                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                ...
                                {!! Form::open(array('route' => array('studios.destroy', $studio->id), 'method' => 'DELETE')) !!}
        ...
        <div class="col-md-3 m-t-50 well">
            ...
            <form action="{{ route('studios.store') }}" method="post" >
                ...
                <div class="col-md-12 m-b-50">
                    <button type ="submit" class="btn btn-lg btn-primary btn-block btn-cons"> ADD NEW STUDIO </button>
