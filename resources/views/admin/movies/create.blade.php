...
@section('content')
    ...
    <div id="admin-container">
        ...
        <div class="admin-section-title">
            <h2> Add New Movie<br>
                <p class="fs-12 ">Create genre, actors, directors before filling a movie</p>
            </h2>
        </div>
        ...
        <form action="{{ route('movies.store') }}" method="post" file="1" enctype="multipart/form-data" id="formVideo">
            ...
            <div class="panel panel-primary" data-collapsed="0" id="ppv_cost_panel">
                <div class="panel-heading">
                    <div class="panel-title">Rental Price</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
                <div class="panel-body" style="display: block;">
                    <p>Add the rental price for pay per view. Eg -> 2.50 . <span class="label label-danger">ONLY PUT NUMBERS</span>
                    </p>
                    <input class="form-control" name="price" id="price" placeholder="rental price"/>
                </div>
            </div>

            <div class="form-group" data-collapsed="0" id="ppv_cost_length">
                <div class="panel-heading">
                    <div class="panel-title">Movie access window to the user</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
                <div class="panel-body" style="display: block;">
                    <p>Put it in hours. Eg -> 48hs (2 days). <span class="label label-danger">ONLY PUT NUMBERS</span>
                    </p>
            ...
            <div class="form-group" data-collapsed="0" id="ppv_cost_length">
                <div class="panel-heading">
                    <div class="panel-title">Movie Duration</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
                <div class="panel-body" style="display: block;">
            ...
            <div class="form-group" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">Video Poster</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
                <div class="panel-body" style="display: block;">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">Director</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">Movie url Source</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
                <div class="panel-body" style="display: block;">
                    <div class="new-wistia">
                        <label for="wistia">
                            <h3><span class="label label-danger">Example: "https://s3-us-west-2.amazonaws.com/frenvid/uploads/koan-inc/a-dogs-tale-1451537665.mp4"</span>
                            </h3>
                        </label>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">Trailer</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
                <div class="panel-body" style="display: block;">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">Movie Description</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">Genre Multiselect</div>
                    <div class="panel-options"><a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                    </div>
                </div>
                <div class="panel-body" style="display: block;">
...
@section('javascript')
    ...
    <script type="text/javascript"
            src="{{ 'assets/admin/js/bootstrap-tagsinput/bootstrap-tagsinput.min.js' }}"></script>
    ...
    <script type="text/javascript">
        ...
        function createRating(type) {
            ...
            if (type == 'movie') {
                ...
                var ratings = {
                    "6": "TV-Y | All Children",
                    "7": "TV-Y7 | Directed to Older Children. Age 7 and above.",
                    "8": "TV-G | General Audience",
                    "9": "TV-PG | Parental Guidance Suggested",
                    "10": "TV-14 | Parents Strongly Cautioned",
                    "11": "TV-MA | Mature Audience Only"
                };
            }
