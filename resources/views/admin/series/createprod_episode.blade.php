...
@section('content')
    ...
    <script>
        ...
        var user_ajax_select_url_i10n = '/studio/get_seasons';
    </script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <form id="uploadForm_film" enctype="multipart/form-data" action="" method="post">
                            ...
                            <div class="form-group">
                                <label class="form-label" name="s3_up_file_film">Add Episode</label>
                                <div class="controls">
                            ...
                            <div class="col-md-12 m-b-50 text-center">
                                <button type="submit" class="btn btn-lg btn-danger"> Add Episode </button>
                ...
                <form action="{{ route('movies.store') }}" method="post" file="1" enctype="multipart/form-data" id="formVideo" class="prod_moviup_form">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body" style="display: block;">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="episode title">
                        </div>
                    </div>
