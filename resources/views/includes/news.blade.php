...
@push('news_meta')
    ...
    <meta name="description"
          content="{{ substr(strip_tags($article->body), 0, 50 ) }}{{ strlen(strip_tags($article->body)) > 50 ? "..." : ""  }}"/>
    <meta property="fb:app_id" content="444736788986613"/>
    <meta property="og:url" content="https://entertale.com/news/{{ $article->slug }}"/>
    <meta property="og:type" content="article"/>
    <meta property="og:title" content="{{ $article->title }}"/>
    <meta property="og:description" content="{{ substr(strip_tags($article->body), 0, 100 ) }}"/>
    <meta property="og:image" content="{{ asset('assets/images/' . $article->image) }}"/>
    <meta property="twitter:card" value="summary_large_image"/>
    <link rel="image_src" href="{{ asset('assets/images/' . $article->image ) }}"/>
...
@section('content')
    ...
    <div class="home-pro">
                    ...
                    <div class="csslider infinity" id="slider1">
                        ...
                        @foreach($last_news as $ln)
                            ...
                            <input type="radio" name="slides"
                                   <?=$count == 1 ? 'checked="checked"' : ''; ?> id="slides_{{$count}}"/>
                        @endforeach

                        <ul>
                            @foreach($last_news as $ln)
                                <li class="slider_href"
                                    style="background-image: url({{ asset('assets/images/' . $ln->image) }})"
                                    data-href="/news/{{$ln->slug}}">
                                    <div id="bg">
                                        <div>
                    ...
                    <a href="/login">
                        <div class="csslider2 infinity" id="slider2">
                            ...
                            @foreach($vidarr as $ln)
                                ...
                                <input type="radio" name="slides2"
                                       <?=$count == 1 ? 'checked="checked"' : ''; ?> id="slides2_{{$count}}"/>
                            @endforeach
                            ...
                            <ul>
                                ...
                                @foreach($vidarr as $ln)
                                    <li class="slider_href"
                                        style="background-image: url('https://img.youtube.com/vi/{{$ln->video_id}}/hqdefault.jpg')"
                                        data-href="/news/{{$ln->slug}}">
                                        <div id="bg">
                                            <div>
                ...
                <div class="nb-3 hidden-sm hidden-xs">
                    <div>
                        ...
                        <script data-cfasync="false" type="text/javascript"
                                src="https://www.liveadexchanger.com/a/display.php?r=1782619"></script>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4 no-padding" style="padding: 1px;">
                            <div class="weat_area text-center">

                                <svg id="wi_1" class="wi_icon thunder-cloud" xmlns="http://www.w3.org/2000/svg"
		...
		c61.8,0,112-50.2,112-112S461.8,64,400,64z"/>
                                ...
                                <svg id="wi_2" class="wi_icon rain-cloud" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
		...
		S444.2,256,400,256z"/>
                                ...
                                <svg id="wi_3" class="wi_icon snow-cloud" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
	...
	c4.1-4.1,10.8-4.1,14.9,0C442.4,392.2,442.4,398.9,438.3,402.9z"/>
                                ...
                                <svg id="wi_4" class="wi_icon sun-cloud" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
        ...
        c-6.2,6.2-6.2,16.4,0,22.6S326.2,112.4,332.4,106.2z"/>
                                ...
                                <svg id="wi_5" class="wi_icon sunshine" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
        ...
        c-6.2,6.2-6.2,16.4,0,22.6L131.5,154.2z"/>
                                ...
                                <svg id="wi_6" class="wi_icon windy-cloud" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
                                    <g class="cloud-wrap">
    ...
    c3.1-0.5,6.3-0.7,9.6-0.7c37.3,0,67.6,30.4,67.6,67.7C480,303,449.7,333.3,412.4,333.3z"/>
                        ...
                        <div class="col-md-4 no-padding" style="padding: 1px;">
                            <div class="weat_area text-center">
                                <h6 style="color: #dadada; margin: 0; padding-top: 4px; font-size: 12px"
                                    id="weat_location"></h6>
    ...
    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2" style="padding-top: 50px; margin-bottom: 50px;">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <ul class="list-inline">
                    <li>
                        <a class="share-btn share-btn-branded share-btn-facebook"
                           href="https://www.facebook.com/sharer/sharer.php?u=https://entertale.com/news/{{ $article->slug }}"
                           title="Share on Facebook">
                            <span class="share-btn-icon"></span>
                            <span class="share-btn-text-sr">Facebook</span>
                        </a>
                        <a class="share-btn share-btn-branded share-btn-twitter"
                           href="https://twitter.com/share?url=https://entertale.com/news/{{ $article->slug }}&text={{$article->title}}&via=entertale.com"
                        ...
                        <a class="share-btn share-btn-branded share-btn-googleplus"
                           href="https://plus.google.com/share?url=https://entertale.com/news/{{ $article->slug }}"
            ...
            @if($article->video)
                <div class="col-md-12">
                    {{--<iframe width="100%" height="300" src="https://www.youtube.com/embed/{{explode('=', $article->video)[1]}}" frameborder="0" allowfullscreen></iframe>--}}
                    <video id="vid_youtube_news" style=" height: 350px; padding: 0;"
            ...
            @else
                <img src="{{ asset('assets/images/' . $article->image) }}"
                     alt="{{ substr(strip_tags($article->title), 0, 25 ) }}{{ strlen(strip_tags($article->title)) > 25 ? "..." : ""  }}"
                     data-pin="pinIt" style="width: 100%; margin-top: 10px;">
            @endif
            <hr>
            ...
            <div class="row hidden-xs hidden-sm" style="padding: 90px 1%">
                @foreach($rand_posts as $rp)
                    <a href="/news/{{$rp->slug}}">
                        <div class="col-md-6" style="margin-top: 20px">
                            `
                            <div class="col-md-4 nopadding">
                                <img src="{{ asset('assets/images/' . $rp->image) }}" alt="{{ $rp->title }}">
                            </div>

                            <div class="col-md-8">

                                <p style="font-size: 18px;margin: -25px 0 3px;color: #6f7b8a; line-height: 22px !important;">
                                    {{ substr(strip_tags($rp->title), 0, 70 ) }}
                                </p>
        ...
        <!---
            ...
            <div class="col-md-12">
                {{--<iframe width="100%" height="300" src="https://www.youtube.com/embed/{{explode('=', $article->video)[1]}}" frameborder="0" allowfullscreen></iframe>--}}
                <video id="vid_youtube_news" style=" height: 250px; padding: 0;" class="video-js vjs-fluid vjs-default-skin" controls data-setup='{ "techOrder": ["youtube"] }' >
        ...
        -->
            <div class="col-md-12">
                <hr>
                <script data-cfasync="false" type="text/javascript"
                        src="https://www.liveadexchanger.com/a/display.php?r=1782639"></script>
            </div>
            ...
            <div class="col-md-12">
                <h4> Latest news </h4>
                @foreach($last_news as $cat_post)
                    <a href="/news/{{$cat_post->slug}}">
                        <h5 style="color: #7b6b6f;">
                            {{substr(strip_tags($cat_post->title), 0, 30 ) }}
                        </h5>
                    </a>
                @endforeach
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">TAGS<div class="panel-controls"></div></div>
                    <div class="panel-body">
                        @foreach($article->tags as $tags)
                        <span style="border-radius: 3px;color: #333333;background-color: #f5f5f5;font-weight: 400;font-style: italic;cursor: pointer; user-select: none;" class="badge bg-success">#{{$tags}}</span>
                            @endforeach
                    </div>
                </div>
            </div>
    ...
    <script src="//a.teads.tv/page/75322/tag" async="true"></script>
